...
import pytz
# to easily convert these table to_dict() i.e JSON
...
class User(db.Model, UserMixin, SerializerMixin):
    ...
    # to denote 1 to many relationship with SearchHistory
...
class PurchasedItem(db.Model, SerializerMixin):
    ...
    date = db.Column(db.DateTime(timezone=True),
                     default=datetime.now(pytz.timezone('Asia/Kathmandu')))
    # to relate the purchase history with the user
